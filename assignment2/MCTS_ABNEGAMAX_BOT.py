...
class Board:
    ...
    def take_random_move(self):
        ...
        #     newstate = self.take_move(move)
        #     newscore = newstate.evaluate_1()
...
class Node:
    def __init__(self, board, actions = None, parent = None):
    ...
    def expand(self):
        ...
        child = Node(newBoard, parent=self)
...
class MCTS:
    ...
    def choose_action(self, board):
        self.root = Node(board, actions=self.actions)
